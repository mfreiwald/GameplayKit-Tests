...
class PlayerBot: GKEntity, ChargeComponentDelegate, ResourceLoadableType {
    ...
    */
    ...
    static func loadResourcesWithCompletionHandler(completionHandler: () -> ()) {
        ...
        let playerBotAtlases = [
            SKTextureAtlas(named: "PlayerBotIdle"),
            SKTextureAtlas(named: "PlayerBotWalk"),
            SKTextureAtlas(named: "PlayerBotInactive"),
            SKTextureAtlas(named: "PlayerBotHit")
        ]
        ...
        */
        SKTextureAtlas.preloadTextureAtlases(playerBotAtlases) {
            /*
