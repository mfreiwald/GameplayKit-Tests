...
class FlyingBot: TaskBot, ChargeComponentDelegate, ResourceLoadableType {
    ...
    override var isGood: Bool {
        didSet {
            guard isGood != oldValue,
                let animationComponent = componentForClass(AnimationComponent.self),
                intelligenceComponent = componentForClass(IntelligenceComponent.self),
                chargeComponent = componentForClass(ChargeComponent.self) else { return }
    ...
    static func loadResourcesWithCompletionHandler(completionHandler: () -> ()) {        
        ...
        let flyingBotAtlases = [
            SKTextureAtlas(named: "FlyingBotGoodWalk"),
            SKTextureAtlas(named: "FlyingBotGoodAttack"),
            SKTextureAtlas(named: "FlyingBotBadWalk"),
            SKTextureAtlas(named: "FlyingBotBadAttack"),
            SKTextureAtlas(named: "FlyingBotZapped")
        ]
        ...
        */
        SKTextureAtlas.preloadTextureAtlases(flyingBotAtlases) {
            /*
