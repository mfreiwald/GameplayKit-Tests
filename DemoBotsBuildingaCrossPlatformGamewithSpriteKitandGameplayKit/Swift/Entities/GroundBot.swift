...
class GroundBot: TaskBot, ChargeComponentDelegate, ResourceLoadableType {
    ...
    static func loadResourcesWithCompletionHandler(completionHandler: () -> ()) {
        ...
        let groundBotAtlases = [
            SKTextureAtlas(named: "GroundBotGoodWalk"),
            SKTextureAtlas(named: "GroundBotBadWalk"),
            SKTextureAtlas(named: "GroundBotAttack"),
            SKTextureAtlas(named: "GroundBotZapped")
        ]
        ...
        */
        SKTextureAtlas.preloadTextureAtlases(groundBotAtlases) {
            /*
