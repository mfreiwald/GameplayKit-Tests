...
struct ColliderType: OptionSetType, Hashable, CustomDebugStringConvertible {
    ...
    static var Obstacle: ColliderType  { return self(rawValue: 1 << 0) }
    static var PlayerBot: ColliderType { return self(rawValue: 1 << 1) }
    static var TaskBot: ColliderType   { return self(rawValue: 1 << 2) }
